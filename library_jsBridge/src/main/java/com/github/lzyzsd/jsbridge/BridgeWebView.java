...
public class BridgeWebView extends WebView implements WebViewJavascriptBridge ,IPageFinishListener {
    ...
    private void init(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            WebView.setWebContentsDebuggingEnabled(true);//you can enable remote debugging through Chrome on your desktop by calling setWebContentsDebuggingEnabled()
        }
		this.setWebViewClient(generateBridgeWebViewClient());//can reset in activity or fragment
	}
